...
- [Subword tokenizers](https://edubruell.github.io/joinery/articles/subword-matching.html). Learn word pieces from your own text when compounds and scanner noise keep whole words apart.
