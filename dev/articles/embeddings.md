...
filter](https://edubruell.github.io/joinery/dev/articles/calibration.md)
for how to fit one. Calibration is the precision answer that the
threshold alone cannot give you.
...
- **The token and phonetic strategies** that should run before the
  ...
  strategies](https://edubruell.github.io/joinery/dev/articles/features.md).
